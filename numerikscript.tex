...
Unter obigen Vorraussetzungen gilt: Es gibt ein offenes Intervall $I$ mit $t_0 \in I$, sodass genau eine Lösung $y: I \rightarrow \mathbb{R}^d$ existiert, mit
...
\begin{enumerate}
  ...
  \item Da $f$ lokal Lipschitz-stetig ist, ist die Voraussetzung des Satzes mit $l = L$ erfüllt. Für das bestmögliche (kleinste) $l$ kann aber $l \ll L$ gelten.
